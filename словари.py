...
fantastic = [ratings[k] for k in shows if shows[k] == "фантастика"]
fantastic = sum(fantastic)/len(fantastic)
print("Средний рейтинг для жанра Фантастика составялет", fantastic)
